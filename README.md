...
| File | What it does |
|------|-------------|
| `.agents/skills/copy-segmentation-system.md` | Defines how to split outbound lists into executable copy segments. |
| `.agents/skills/copy-message-architecture.md` | Builds first-touch emails with a constrained 4-block structure. |
| `.agents/skills/copy-subject-opener-engine.md` | Generates subject and opener variants with anti-spam controls. |
| `.agents/skills/copy-cta-friction-design.md` | Selects CTA style by touch stage and buyer readiness. |
| `.agents/skills/copy-follow-up-sequence.md` | Designs touches 2-5 with new value and close logic. |
| `.agents/skills/copy-quality-compliance-review.md` | Runs quality, deliverability, and compliance checks before launch. |
